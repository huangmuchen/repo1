package com.xuecheng.common.client;

/**
 * @author: HuangMuChen
 * @date: 2020/5/23 16:51
 * @version: V1.0
 * @Description: 服务列表(发布到eureka注册中心)
 */
public class XcServiceList {
    public static final String XCEDU_REGISTRY = "xcEdu-registry";
    public static final String XCEDU_SEARCH = "xcEdu-search";
    ...
    public static final String XCEDU_LEARNING = "xcEdu-learning";
}